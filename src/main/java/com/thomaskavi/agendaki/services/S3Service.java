...
public class S3Service {
  ...
  public URL uploadFile(MultipartFile file, String professionalName) {
    try {
      String originalName = file.getOriginalFilename();
      String extension = FilenameUtils.getExtension(originalName);
      String sanitized = professionalName.trim().toLowerCase().replaceAll("[^a-z0-9]", "_");
      String fileName = sanitized + "_" + Instant.now().toEpochMilli() + "." + extension;
